...
const MAX_CURSED_ENERGY = 100
const MIN_CURSED_ENERGY_GAIN = 5
const MAX_CURSED_ENERGY_GAIN = 30



var cursed_energy_gain = lerp(MIN_CURSED_ENERGY_GAIN, MAX_CURSED_ENERGY_GAIN, (MAX_HEALTH / hp))
var current_cursed_energy = MAX_CURSED_ENERGY
